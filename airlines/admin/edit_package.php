            ...
            <?php } ?>
                <form role="form" action="update_destination.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="package_name" id="package_name" value="<?php echo $data['package_name'];?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="iframe" id="iframe" value="<?php echo $data['iframe'];?>" required>
                    </div>
                    <div class="form-group">
